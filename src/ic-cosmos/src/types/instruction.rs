...
pub enum InstructionError {
    ...
    /// by the cosmos runtime. A program-specific error may be any type that is represented as
    ...
    /// consistent across cosmos software versions.
...
/// which is the core of a cosmos transaction. It is created during the
