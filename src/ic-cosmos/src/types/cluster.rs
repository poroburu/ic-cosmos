...
impl Cluster {
    ...
    pub fn url(&self) -> &str {
        match self {
            Cluster::Devnet => "https://api.devnet.cosmos.com",
    ...
    pub fn ws_url(&self) -> &str {
        match self {
            Cluster::Devnet => "wss://api.devnet.cosmos.com",
            Cluster::Testnet => "wss://api.testnet.cosmos.com",
            Cluster::Mainnet => "wss://api.mainnet-beta.cosmos.com",
